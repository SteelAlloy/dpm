...
export class InitCommand extends BaseCommand {
  ...
  async runCommand () {
    ...
    try {
      ...
      const dpmTs = await Deno.open(`${ executeDir }/deno_modules/dpm.ts`, { write: true, create: true })
      await Deno.writeAll(dpmTs, encoder.encode(`// generated via dpm v${ Config.version } - Deno Package Manager\n// https://deno.land/x/dpm\n// dpm dependencies export file\n// do not edit this file unless you know what you're doing\n`))
      dpmTs.close()
